...
export async function createTransaction(data) {
    try {
        ...
        //prisma transaction for incase of failure the system roll backs
...
export async function scanReceipt(file) {
    try {
      ...
      If its not a recipt, return an empty object`
        ...
        console.error("Error scannning the receipt: ", error.message);
...
export async function updateTransaction(id, data) {
    try {
        ...
        //get original transaction to calculate balance cange
